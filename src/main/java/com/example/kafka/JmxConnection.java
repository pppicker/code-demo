...
public class JmxConnection {
      ...
      private String ipAndPort = "55.11.59.173:9999";
      private int port = 9999;
      private boolean newKafkaVersion = true;
      ...
      public boolean init(){
            ...
            try {
                  ...
                  environment.put(JMXConnector.CREDENTIALS, new String[]{"admin", "21da82c5-6e38-4c98-9ac4-913a1c6bd9c9"});
